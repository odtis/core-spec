# Reliance Extensions: R-Liveness - ODTIS-0728

**Status:** implemented (static + policy smoke)
**Sub-module:** R-Liveness
**Requirements:** ODTIS-0728 (normative)
...
2. Review operator policy and audit exports: NOT be reused outside its declared purpose, and MUST NOT be treated as identity proof or statutory age proof without explicit authorization.
3. Record evidence (policy document, audit export, or API trace as applicable).

## Pass criteria

Implementation satisfies ODTIS-0728 as declared in section 11 and Annex E (`ODTIS-0707` no-weakening applies).
