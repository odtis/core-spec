# Reliance Extensions: R-Agent-Authority - ODTIS-0711

**Status:** implemented (static + policy smoke)
**Sub-module:** R-Agent-Authority
**Requirements:** ODTIS-0711 (normative)
...
2. Verify signed mandate includes allowed/prohibited actions and limits; delegation hop narrows scope.
3. Record evidence (policy document, audit export, or API trace as applicable).

## Pass criteria

Implementation satisfies ODTIS-0711 as declared in section 11 and Annex E (`ODTIS-0707` no-weakening applies).
