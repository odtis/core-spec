# Reliance Extensions: R-Travel - ODTIS-0757

**Status:** implemented (static + policy smoke)
**Sub-module:** R-Travel
**Requirements:** ODTIS-0757 (normative)
...
2. Review operator policy and audit exports: A recourse endpoint and cross-border recognition scope SHOULD be published per touchpoint.
3. Record evidence (policy document, audit export, or API trace as applicable).

## Pass criteria

Implementation satisfies ODTIS-0757 as declared in section 11 and Annex E (`ODTIS-0707` no-weakening applies).
