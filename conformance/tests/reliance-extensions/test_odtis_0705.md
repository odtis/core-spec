# Reliance Extensions: R-Base - ODTIS-0705

**Status:** implemented (static + policy smoke)
**Sub-module:** R-Base
**Requirements:** ODTIS-0705 (normative)
...
2. Review operator policy documents published recourse path for contested reliance decisions.
3. Record evidence (policy document, audit export, or API trace as applicable).

## Pass criteria

Implementation satisfies ODTIS-0705 as declared in section 11 and Annex E (`ODTIS-0707` no-weakening applies).
