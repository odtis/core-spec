# Reliance Extensions: R-Base - ODTIS-0702

**Status:** implemented (static + policy smoke)
**Sub-module:** R-Base
**Requirements:** ODTIS-0702 (normative)
...
2. Attempt attribute use outside declared purpose; system MUST refuse and log purpose_binding violation.
3. Record evidence (policy document, audit export, or API trace as applicable).

## Pass criteria

Implementation satisfies ODTIS-0702 as declared in section 11 and Annex E (`ODTIS-0707` no-weakening applies).
