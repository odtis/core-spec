# Reliance Extensions: R-Liveness - ODTIS-0729

**Status:** implemented (static + policy smoke)
**Sub-module:** R-Liveness
**Requirements:** ODTIS-0729 (normative)
...
2. Review operator policy and audit exports: provide an accessible non-camera fallback of equivalent outcome and a recourse path for false rejection.
3. Record evidence (policy document, audit export, or API trace as applicable).

## Pass criteria

Implementation satisfies ODTIS-0729 as declared in section 11 and Annex E (`ODTIS-0707` no-weakening applies).
