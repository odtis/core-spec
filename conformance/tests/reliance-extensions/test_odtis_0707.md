# Reliance Extensions: R-Base - ODTIS-0707

**Status:** implemented (static + policy smoke)
**Sub-module:** R-Base
**Requirements:** ODTIS-0707 (normative)
...
2. Static review: Reliance Extension MUST NOT relax any Core/Trust Network/Federation/Operator MUST.
3. Record evidence (policy document, audit export, or API trace as applicable).

## Pass criteria

Implementation satisfies ODTIS-0707 as declared in section 11 and Annex E (`ODTIS-0707` no-weakening applies).
