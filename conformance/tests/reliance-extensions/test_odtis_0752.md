# Reliance Extensions: R-Stablecoin-CIP - ODTIS-0752

**Status:** implemented (static + policy smoke)
**Sub-module:** R-Stablecoin-CIP
**Requirements:** ODTIS-0752 (normative)
...
2. Review operator policy and audit exports: reference an annual AML/CFT and CIP certification and MUST bind the decision to account-opening purpose.
3. Record evidence (policy document, audit export, or API trace as applicable).

## Pass criteria

Implementation satisfies ODTIS-0752 as declared in section 11 and Annex E (`ODTIS-0707` no-weakening applies).
