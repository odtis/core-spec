# Reliance Extensions: R-Document-Capture - ODTIS-0723

**Status:** implemented (static + policy smoke)
**Sub-module:** R-Document-Capture
**Requirements:** ODTIS-0723 (normative)
...
2. Document verification reliance record declares capture mode and forensics tiers in scope.
3. Record evidence (policy document, audit export, or API trace as applicable).

## Pass criteria

Implementation satisfies ODTIS-0723 as declared in section 11 and Annex E (`ODTIS-0707` no-weakening applies).
