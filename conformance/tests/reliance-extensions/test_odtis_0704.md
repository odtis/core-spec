# Reliance Extensions: R-Base - ODTIS-0704

**Status:** implemented (static + policy smoke)
**Sub-module:** R-Base
**Requirements:** ODTIS-0704 (normative)
...
2. Verify audit evidence reference is tamper-evident and reconstructable from audit store by correlation ID.
3. Record evidence (policy document, audit export, or API trace as applicable).

## Pass criteria

Implementation satisfies ODTIS-0704 as declared in section 11 and Annex E (`ODTIS-0707` no-weakening applies).
