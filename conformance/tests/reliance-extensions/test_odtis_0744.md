# Reliance Extensions: R-Assurance-Portability - ODTIS-0744

**Status:** implemented (static + policy smoke)
**Sub-module:** R-Assurance-Portability
**Requirements:** ODTIS-0744 (normative)
...
2. Review operator policy and audit exports: evaluate step-up requirements against its own risk tier before reusing assurance, rather than inheriting a prior yes/no decision.
3. Record evidence (policy document, audit export, or API trace as applicable).

## Pass criteria

Implementation satisfies ODTIS-0744 as declared in section 11 and Annex E (`ODTIS-0707` no-weakening applies).
