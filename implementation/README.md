...
| Trust network UI | `../core-impl/ven-trust-network-web/` | *(informative - not ODTIS)* | [Scope](https://github.com/odtis/core-impl/blob/main/ven-trust-network-web/SCOPE.md) |
