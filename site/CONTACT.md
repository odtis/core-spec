---
title: Contact
description: Reach editors, submit feedback, and collaborate
---
...
Channels for specification feedback, collaboration proposals, press, and general inquiries.

</div>

---

## Specification & normative feedback

| Channel | Use for |
|---------|---------|
| [GitHub Issues](https://github.com/odtis/core-spec/issues) | Clarifications, RFCs, sandbox L2 reports |
...
Report suspected vulnerabilities in the **reference implementation** through your operator's security channel. For **normative spec security** issues (ambiguous MUST, missing threat control), use a GitHub issue labeled `security` or email stewards with `ODTIS security` in the subject.
...
| Goal | Document |
|------|----------|
| Collaboration proposal | [Collaborate](COLLABORATE.md) |
| Normative feedback | [Feedback channels](../governance/FEEDBACK.md) |
| Review cycle 1 | [External review cycle 1](../governance/REVIEW-CYCLE-1.md) |
